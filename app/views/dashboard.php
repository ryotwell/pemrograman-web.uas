            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6 transform hover:scale-105 transition duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-indigo-600"><?= htmlspecialchars($students_count) ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6 transform hover:scale-105 transition duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-purple-600"><?= htmlspecialchars($users_count) ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex space-x-4">
                <div class="relative inline-block">
                    ...
                    <div id="exportDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-10">
                        <a href="/students/export/excel" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 rounded-t-lg">Export to Excel</a>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap font-medium"><?= htmlspecialchars($student->name) ?></td>
                        <td class="px-6 py-4 whitespace-nowrap"><?= htmlspecialchars($student->email) ?></td>
                        <td class="px-6 py-4 whitespace-nowrap"><?= htmlspecialchars($student->phone_number) ?></td>
                        <td class="px-6 py-4 whitespace-nowrap"><?= htmlspecialchars($student->major->name) ?></td>
                        <td class="px-6 py-4 whitespace-nowrap"><?= htmlspecialchars($student->gender) ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="/students/<?= htmlspecialchars($student->id) ?>/edit" class="text-blue-600 hover:text-blue-900 mr-3 transition duration-200 inline-block">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </a>
                            <a href="/students/<?= htmlspecialchars($student->id) ?>/delete" class="text-red-600 hover:text-red-900 transition duration-200 inline-block">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
